        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 
                  以前咱们的路由跳转：从A路由跳转到8路由，
                  这里在加入购物车，进行路由跳转之前，发请求把你购买的产品的信息通过请
                  求的形式通知服务器，服务器进行相应的存储
                -->
    ...
    async addShopCar() {
     ...
     // 2. 服务器存储成功 ---进行路由跳转传递参数 --------失败 - 触发提示
      try {
        ...
        //产品信息的数据【比较复杂：skulnfo],通过会话存储（不持久化，会话结束数据在消失）
        // 本地存储|会话存储 一般存储的是字符串
        sessionStorage.setItem("SKUINFO",JSON.stringify(this.skuInfo))
        sessionStorage.setItem("SSAV",JSON.stringify(this.spuSaleAttrList))
